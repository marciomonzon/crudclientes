...
<head>
  ...
  <title>Dashboard Loteamentos</title>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <span class="hidden-xs">Usuario Logado: <?php echo $this->session->userdata("nome"). " " .$this->session->userdata("sobrenome"); ?></span>
                            </a>
                            <ul class="dropdown-menu">
                                <li class="user-body">
                                    <div class="row">
                                        <div class="col-xs-12 text-center">
                                            <a href="<?php echo base_url();?>index.php/auth/logout"> Sair do Sistema</a>
                                        </div>
                                    </div>
                                    <!-- /.row -->
                                </li>
